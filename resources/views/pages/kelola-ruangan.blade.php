...
@section('title')
    Kelola Ruangan - Sistem Informasi Sarana dan Prasarana
@endsection

@section('content')
{{-- START: Content --}}
<div class="container mx-auto px-6 my-8">
  <h3 class="text-gray-800 text-2xl font-medium text-center dark:text-gray-50">Ruangan</h3>
  <h6 class="mt-1 mb-2 text-center text-xs text-gray-600">Kelola ruangan dengan sebaik mungkin.</h6>
