...
@section('title')
    Data Guru - Sistem Informasi Sarana dan Prasarana
@endsection

@section('content')
<div class="container mx-auto py-8 md:px-14 px-5">
    <h3 class="text-gray-800 text-2xl font-medium text-center dark:text-gray-50">Data Guru</h3>
    <h6 class="mt-1 mb-8 text-center text-xs text-gray-600">Kelola data guru dengan sebaik mungkin.</h6>
    
    <hr class="my-4 border-gray-600"/>

    <form action="{{ route('kelola-guru') }}" method="GET">
    ...
    <div class="my-4">
        ...
        <div class="hidden md:flex flex-row items-center justify-between">
          <div class="flex flex-row space-x-2">
            ...
            <a href="#" class="deleteSemuaGuru flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-400 border border-transparent rounded-lg hover:bg-red-500 focus:outline-none">
              <svg class="w-4 h-4 mr-1 -ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="flex flex-row justify-end">
            <a href="{{ route('tong-sampah-guru') }}" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-400 border border-transparent rounded-lg hover:bg-red-500 focus:outline-none">
              <svg class="w-4 h-4 mr-1 -ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
              <span>Sampah</span>
        ...
        <div class="flex md:hidden flex-row items-end justify-between">
          ...
          <div class="flex flex-row">
            <a href="{{ route('tong-sampah-guru') }}" class="flex items-center justify-center px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-400 border border-transparent rounded-lg hover:bg-red-500 focus:outline-none">
              <svg class="w-4 h-4 mr-1 -ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
              <span>Sampah</span>
        ...
        <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap table-auto mb-2">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">{{ $guru->nip }}</td>
                    <td class="px-4 py-3 text-sm">{{ $guru->golongan }}</td>
                    <td class="px-4 py-3 text-sm">{{ $guru->keterangan }}</td>
                    <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                            ...
                            <a
                            href="#"
                            class="deleteGuru flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" guru-id="{{ $guru->id }}" guru-nama="{{ $guru->nama }}"
                            aria-label="Delete"
                            >
                            <svg
                                class="w-5 h-5"
