    ...
    <section class="py-8">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-row items-center justify-between mt-2">
              ...
              <div class='w-full md:w-1/2 px-3'>
                <label class='block tracking-wide text-gray-800 dark:text-gray-50 text-xs font-bold mb-2' for="sumber_dana">Sumber Dana</label>
                <div class="flex-shrink w-full inline-block relative">
                    <select class="block appearance-none text-gray-600 w-full bg-gray-50 dark:bg-gray-800 border border-gray-400 dark:border-gray-800 dark:text-gray-50 shadow-inner px-4 py-2 pr-8 rounded focus:outline-none" name="sumber_dana" id="sumber_dana">
                        <option value="">-Pilih-</option>
