                ...
                <div class='flex flex-wrap -mx-3 mb-6'>
                    ...
                    <div class="flex items-center justify-between w-full">
                        <div class='w-full md:w-1/2 px-3 mb-6'>
                            <label class='block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2' for="jumlah">Jumlah</label>
                            <input class='appearance-none block w-full bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-50 border border-gray-300 dark:border-gray-600 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none focus:border-gray-700 @error('jumlah') is-invalid @enderror' type='number' name="jumlah" id="jumlah" value="{{ $barang->jumlah }}">
                            @error('jumlah')
                            <span class="text-xs text-red-600 dark:text-red-400">
                                {{ $message }}
                            </span>
                        ...
                        <div class='w-full md:w-1/2 px-3 mb-6'>
                            <label class='block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2' for="satuan">Satuan</label>
                            ...
                            <select class="block appearance-none text-gray-600 w-full bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 dark:text-gray-50 shadow-inner px-4 py-2 pr-8 rounded focus:outline-none @error('satuan') is-invalid @enderror" name="satuan" id="satuan">
                                <option>-Pilih-</option>
                                <option value="Buah" @if($barang->satuan == "Buah") selected @endif>Buah</option>
                                <option value="Unit" @if($barang->satuan == "Unit") selected @endif>Unit</option>
                                <option value="Lembar" @if($barang->satuan == "Lembar") selected @endif>Lembar</option>
                                <option value="Set" @if($barang->satuan == "Set") selected @endif>Set</option>
                            </select>
                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        <label class='block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2' for="sumber_dana_id">Sumber Dana</label>
                        <div class="flex-shrink w-full inline-block relative">
                            <select class="block appearance-none text-gray-600 w-full bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 dark:text-gray-50 shadow-inner px-4 py-2 pr-8 rounded focus:outline-none @error('sumber_dana_id') is-invalid @enderror" name="sumber_dana_id" id="sumber_dana_id">
                                ...
                                @foreach (sumberDana() as $sumberDana)
                                    <option value="{{ $sumberDana->id }}" @if($barang->sumber_dana_id == $sumberDana->id) selected @endif >{{ $sumberDana->sumber_dana }}</option>
                                @endforeach
                            </select>
                            <div class="pointer-events-none absolute top-0 mt-3  right-0 flex items-center px-2 text-gray-600">
                                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        <label class='block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2' for="tahun_barang">Tahun Barang</label>
                        <div class="flex-shrink w-full inline-block relative">
                            <select class="block appearance-none text-gray-600 w-full bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 dark:text-gray-50 shadow-inner px-4 py-2 pr-8 rounded focus:outline-none @error('tahun_barang') is-invalid @enderror" name="tahun_barang" id="tahun_barang">
                                ...
                                @for ($i = 1995; $i <= $tahunNow; $i++)
                                    <option value="{{ $i }}" @if($barang->tahun_barang == $i) selected @endif>{{ $i }}</option>
                                @endfor
                            </select>
                            <div class="pointer-events-none absolute top-0 mt-3  right-0 flex items-center px-2 text-gray-600">
                                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        ...
                        <div class="flex-shrink w-full inline-block relative">
                            <select class="block appearance-none text-gray-600 w-full bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 dark:text-gray-50 shadow-inner px-4 py-2 pr-8 rounded focus:outline-none @error('kondisi') is-invalid @enderror" name="kondisi" id="kondisi">
                                ...
                                <option value="Rusak Ringan" @if($barang->kondisi == "Rusak Ringan") selected @endif>Rusak Ringan</option>
                    ...
                    <div class="h-56 w-full md:w-56 bg-cover rounded-lg shadow-lg bg-white dark:bg-gray-800 mt-6" style="background-image: 
                            @if($barang->image_url != null) 
                                url('{{ asset('storage/unggah/Barang/' . $ruangan->nama_ruangan . '/' . $barang->image_url) }}') 
                            @else
                                url('{{ asset('img/404.png') }}')
                            @endif
                    ">
                        <div class="flex justify-end -mt-3 md:block md:ml-40">
                            <a href="#" class="deleteFoto" barang-id="{{ $barang->id }}" ruangan-id="{{ $ruangan->id }}">
