...
@section('title')
    Cetak Laporan Barang Berdasarkan Ruangan - Sistem Informasi Sarana dan Prasarana
@endsection
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-row justify-between items-center">
                ...
                <div class="flex flex-col">
                    <h3 class="text-gray-800 text-2xl font-medium text-center dark:text-gray-50">Cetak Laporan Barang Berdasarkan Ruangan</h3>
