...
@section('title')
    Tong Sampah Barang {{ $ruangan->nama_ruangan }} - Sistem Informasi Sarana dan Prasarana
@endsection
...
<div class="container mx-auto py-8 md:px-20 px-5">
    <div class="flex flex-row justify-between items-center">
        ...
        <div class="flex flex-col">
            <h3 class="text-gray-800 text-2xl font-medium text-center dark:text-gray-50">Tong Sampah Barang di {{ $ruangan->nama_ruangan }}</h3>
